...
1. **Markdownファイルの読み込みと分析**
   - ユーザーが提供したMarkdownファイルまたはテキストを読み込み
   - 内容を解析して、スライド構成を理解
...
- スライドの内容（テキスト、データ、コード等）を提供
- 必要に応じて画像やデータを提供（求められた場合のみ）
- レイアウトの選択（提案された場合のみ）
...
Markdownファイルを最初に読んだ段階で、レイアウトを検討し、必要に応じてユーザーに確認します。
